...
### Что нужно доделать:
- [ ] **Авто-переключение ноды при падении скорости** — мониторить скорость, если ниже порога N секунд → автоматически переключиться на следующую ноду (hot-swap). Порог и задержка настраиваемые.
